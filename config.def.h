...
static const char *fonts[]          = { "Space Mono:size=11" };
...
static const char col_gray4[]       = "#1f2430";
static const char col_gray5[]       = "#333c50";
static const char col_cyan[]        = "#f28779";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_gray1 },
	[SchemeSel]  = { col_gray4, col_cyan,  col_cyan  },
	[SchemeStatus]  = { col_gray3, col_gray1,  "#000000"  }, // Statusbar right {text,background,not used but cannot be empty}
	[SchemeTagsSel]  = { col_cyan, col_gray5,  "#000000"  }, // Tagbar left selected {text,background,not used but cannot be empty}
	[SchemeTagsNorm]  = { col_gray3, col_gray1,  "#000000"  }, // Tagbar left unselected {text,background,not used but cannot be empty}
	[SchemeInfoSel]  = { col_gray3, col_gray5,  "#000000"  }, // infobar middle  selected {text,background,not used but cannot be empty}
...
/* commands */
static char dmenumon[2] = "0"; // im not using dmenu. This line exist to prevent compiler errors
